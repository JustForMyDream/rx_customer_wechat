...
public class TLkKhCbxxEntity {
    ...
    private String sign;
    private String itemCbzl;
    private String itemSsbh;
    private String itemDwmc;
    private String itemRyssqy;
    private String itemSftx;
    private Date itemCbkssj;
    private String itemDqzt;
    private String itemKhid;
    private String id;

    public TLkKhCbxxEntity(String itemCbzl, String itemSsbh,
                           String itemDwmc, String itemRyssqy, String itemSftx, Date itemCbkssj, String itemDqzt,String id) {
        this.id = id;
        this.itemCbzl = itemCbzl;
        this.itemSsbh = itemSsbh;
        this.itemDwmc = itemDwmc;
        this.itemRyssqy = itemRyssqy;
        this.itemSftx = itemSftx;
        this.itemCbkssj = itemCbkssj;
        this.itemDqzt = itemDqzt;
    }
    public void TLkKhCbxxEntitybyid(String itemCbzl, String itemSsbh,
                                    String itemDwmc, String itemRyssqy, String itemSftx, Date itemCbkssj,  String itemDqzt) {
        this.itemCbzl = itemCbzl;
        this.itemSsbh = itemSsbh;
        this.itemDwmc = itemDwmc;
        this.itemRyssqy = itemRyssqy;
    ...
    public String getItemCbzl() {
        return itemCbzl;
    }

    public void setItemCbzl(String itemCbzl) {
        this.itemCbzl = itemCbzl;
    }

    public String getItemSsbh() {
        return itemSsbh;
    }

    public void setItemSsbh(String itemSsbh) {
        this.itemSsbh = itemSsbh;
    }
    ...
    public String getItemRyssqy() {
        return itemRyssqy;
    }

    public void setItemRyssqy(String itemRyssqy) {
        this.itemRyssqy = itemRyssqy;
    }

    public String getItemSftx() {
        return itemSftx;
    }

    public void setItemSftx(String itemSftx) {
        this.itemSftx = itemSftx;
    }

    public Date getItemCbkssj() {
        return itemCbkssj;
    }

    public void setItemCbkssj(Date itemCbkssj) {
        this.itemCbkssj = itemCbkssj;
    }

    public String getItemDqzt() {
        return itemDqzt;
    }

    public void setItemDqzt(String itemDqzt) {
        this.itemDqzt = itemDqzt;
    }
