...
public class TlkQdFcxxEntity {
    ...
    private String sign;
    private String itemFcxz;
    private String itemJzlx;
    private String itemSzsfqq;
    private String itemGtzqk;
    private Date itemGfsj;
    private String itemJzmj;
    private String itemQdid;
    private String id;
    private double itemYgje;
    private double itemScdj;
    ...
    public String getItemFcxz() {
        return itemFcxz;
    }

    public void setItemFcxz(String itemFcxz) {
        this.itemFcxz = itemFcxz;
    }

    public String getItemJzlx() {
        return itemJzlx;
    }

    public void setItemJzlx(String itemJzlx) {
        this.itemJzlx = itemJzlx;
    }

    public String getItemSzsfqq() {
        return itemSzsfqq;
    }

    public void setItemSzsfqq(String itemSzsfqq) {
        this.itemSzsfqq = itemSzsfqq;
    }

    public String getItemGtzqk() {
        return itemGtzqk;
    }

    public void setItemGtzqk(String itemGtzqk) {
        this.itemGtzqk = itemGtzqk;
    }

    public Date getItemGfsj() {
        return itemGfsj;
    }

    public void setItemGfsj(Date itemGfsj) {
        this.itemGfsj = itemGfsj;
    }

    public String getItemJzmj() {
        return itemJzmj;
    }

    public void setItemJzmj(String itemJzmj) {
        this.itemJzmj = itemJzmj;
    }
    ...
    public double getItemScdj() {
        return itemScdj;
    }

    public void setItemScdj(double itemScdj) {
        this.itemScdj = itemScdj;
    }
}
