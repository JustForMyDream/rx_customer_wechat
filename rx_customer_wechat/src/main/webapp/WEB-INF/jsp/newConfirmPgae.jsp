...
<head>
    ...
    <script type="text/javascript" src="http://webapi.amap.com/maps?v=1.3&key=3d37054c7dbfc8130f470631230f89e0"></script>
...
//        document.getElementById('tip').innerHTML = str.join('<br>');
    ...
    function go() {
        window.location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxb5e53b1e6a25c317&redirect_uri=http%3A%2F%2Fwechat.cdrxjr.com%2Frx%2FoauthWechat%2FauthUserLogin&response_type=code&scope=snsapi_userinfo&state="+state+"#wechat_redirect";
    }
</script>
</html>