...
public class TlkQdGjjxxEntity {
    ...
    public double getItemGjjjcje() {
        return itemGjjjcje;
    }

    public void setItemGjjjcje(double itemGjjjcje) {
        this.itemGjjjcje = itemGjjjcje;
    }
}
