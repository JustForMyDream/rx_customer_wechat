...
public class TLkKhClxxEntity {
    ...
    private String sign;
    private String itemClpp;
    private String itemGcqk;
    private String itemClgls;
    private String itemKhid;
    private String id;
    private Date itemGcsj;
    private double itemLcj;
    private double itemYgje;
    private String itemCph;
    private Date itemCcsj;
    private String itemClss;

    public String getItemCph() {
        return itemCph;
    }

    public void setItemCph(String itemCph) {
        this.itemCph = itemCph;
    }

    public Date getItemCcsj() {
        return itemCcsj;
    }

    public void setItemCcsj(Date itemCcsj) {
        this.itemCcsj = itemCcsj;
    }

    public String getItemClss() {
        return itemClss;
    }

    public void setItemClss(String itemClss) {
        this.itemClss = itemClss;
    }

    public TLkKhClxxEntity(String itemClpp, Date itemGcsj, double itemLcj, double itemYgje, String id, String itemCph, Date itemCcsj, String itemClss) {
        this.id = id;
        this.itemClpp = itemClpp;
        this.itemGcsj = itemGcsj;
        this.itemLcj = itemLcj;
        this.itemYgje = itemYgje;
        this.itemCph = itemCph;
        this.itemCcsj = itemCcsj;
        this.itemClss = itemClss;
    }
    public void tLkKhClxxEntityid(String itemClpp, Date itemGcsj, double itemLcj, double itemYgje, String itemCph, Date itemCcsj, String itemClss){
        this.itemClpp = itemClpp;
        this.itemGcsj = itemGcsj;
        this.itemLcj = itemLcj;
        this.itemYgje = itemYgje;
    ...
    public String getItemClpp() {
        return itemClpp;
    }

    public void setItemClpp(String itemClpp) {
        this.itemClpp = itemClpp;
    }

    public String getItemGcqk() {
        return itemGcqk;
    }

    public void setItemGcqk(String itemGcqk) {
        this.itemGcqk = itemGcqk;
    }



    public String getItemClgls() {
        return itemClgls;
    }

    public void setItemClgls(String itemClgls) {
        this.itemClgls = itemClgls;
    }
    ...
    public Date getItemGcsj() {
        return itemGcsj;
    }

    public void setItemGcsj(Date itemGcsj) {
        this.itemGcsj = itemGcsj;
    }

    public double getItemLcj() {
        return itemLcj;
    }

    public void setItemLcj(double itemLcj) {
        this.itemLcj = itemLcj;
    }
